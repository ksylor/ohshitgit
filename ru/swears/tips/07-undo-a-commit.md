---
tags: tip
title: Пиздец, мне нужно отменить коммит, который был 5 коммитов назад!
id: отменить-коммит
order: 7
---
...
Вам не нужно откатываться назад и копипастить старый файл в существующий! Если вы закоммитили дичь, её можно убрать с `revert`.
